...
public class IndianStateCensusAnalyzerTest {
    ...
    public void givenTheStateCensusCSVFileEnsuresNumberOfRecordsMatches() throws CustomizedExceptions {
        String filePath = "C:\\Users\\Chaithra\\IdeaProjects\\IndianStateCensusAnalyzer\\src\\main\\java\\org\\example\\Files\\StateCensusData.csv";
    ...
    public void givenStateCensusCSVFileIfIncorrectReturnsCustomException() {
        ...
        String filePath = "C:\\Users\\Chaithra\\IdeaProjects\\IndianStateCensusAnalyzer\\src\\main\\java\\org\\example\\Files\\StatecnsData.csv";
        try {
            int result = id.getNumberOfRecords(filePath);
            Assert.assertEquals(29, result);
    ...
    public void givenStateCensusCSVFileWhenCorrectButTypeIncorrectReturnsCustomExceptions() {
        ...
        String filePath = "C:\\Users\\Chaithra\\IdeaProjects\\IndianStateCensusAnalyzer\\src\\main\\java\\org\\example\\Files\\StateCensusData.pdf";
        try {
            int result = id.getNumberOfRecords(filePath);
